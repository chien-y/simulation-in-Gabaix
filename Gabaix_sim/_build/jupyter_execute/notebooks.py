...
When firm's growth rate is $12\%$, the deviation of growth rate $ \sigma_{GDP} = h\sigma $ is around $0.1\%$ for log-normal which is much lower than $0.94\%$ of Pareto given $\zeta=1.059$. Since the empirically measured macroeconomic fluctuation is around $1\%$, the log-normal distribution is not reasonable under this matching method and simulation. 
