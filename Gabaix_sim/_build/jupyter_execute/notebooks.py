...
## The Setup
To begin with, simulate the herfindhl for Pareto distribution. The formulas are from {cite}`gabaix2011granular`. Assume that all firms have identical volatility $\sigma$.
